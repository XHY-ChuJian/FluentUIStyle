...
SpectrumDemoWindow::SpectrumDemoWindow(QWidget *parent)
    : QMainWindow(parent)
{
    setWindowTitle(tr("ExSpectrumWidget Demo"));
    resize(720, 280);
    ...
    m_spectrum = new ExSpectrumWidget(central);
...
void SpectrumDemoWindow::feedSimulatedAudio()
{
    ...
    const int sampleCount = qMax(256, m_generator ? (44100 * ExSpectrumWidget::DefaultRefreshIntervalMs / 1000) : 512);
