...
public:
    ...
    EXWIDGETS_DECLARE_PROPERTY( QColor, activeColor, activeColor, setActiveColor, QColor( 255, 140, 0 ) )
    EXWIDGETS_DECLARE_PROPERTY( QColor, inactiveColor, inactiveColor, setInactiveColor, QColor() )
    EXWIDGETS_DECLARE_PROPERTY( QColor, warningColor, warningColor, setWarningColor, QColor( 255, 185, 0 ) )
    EXWIDGETS_DECLARE_PROPERTY( QColor, clipColor, clipColor, setClipColor, QColor( 232, 17, 35 ) )
    EXWIDGETS_DECLARE_PROPERTY( QColor, peakColor, peakColor, setPeakColor, QColor( 255, 255, 255 ) )
