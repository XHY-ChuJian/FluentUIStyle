...
private:
    ...
    void drawProgressRing( const QStyleOptionProgressBar* option, QPainter* painter, const QWidget* widget, bool drawTrack ) const;
    ...
    void drawLineEditFrame( QPainter* painter,
                            const QRectF& rect,
                            const QStyleOption* option,
                            bool isEditable    = true,
                            int roundingRadius = 4 ) const;

    void drawPopupShadow( QPainter* painter, const QRectF& panelRect, int radius, int extent ) const;
